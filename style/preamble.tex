...
\fancypagestyle{plain}{
  ...
  \fancyfoot[LO,RE]{~\thepage~}      % page numbers Right Oneven, Left Rven
}
...
\fancypagestyle{toc}{
  ...
  %\fancyfoot{}                       % clear footers
  %\renewcommand{\headrulewidth}{0pt} % no line at top of page
  %\fancyfoot[LE]{~\thepage~}      % page numbers Right Odd, Left Even
}
...
% Set margins
\usepackage[paperheight=24cm,paperwidth=17cm,top=2cm,bottom=2cm,left=2cm,right=2cm]{geometry}
