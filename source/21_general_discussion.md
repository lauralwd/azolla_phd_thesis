...
This tightly intertwined mutualism makes _Azolla_ an interesting novel-crop independent of Nitrogen fertiliser, as well as a notorious weed threatening to overgrow eutrophied aquatic ecosystems.
In the general introduction, I shared my view on the field and introduced main concepts in three sections that I will revisit in the general discussion.
...
- read about key communities in microbiome editing
- experiments
  - place associated microbes in species trees
  - assess degradation
...
### whole itsnts braindump by yours truely
...
species
1. assume systematic inheritance of organisms and genes via megaspores (1 parent
  maternal transmission)
1. if these have differential bennefit, there's classic darwinian evolution
...
how many other genus-metagenomes are out there in the data. How to look for those.
...
### Subdivide in the Azolla genus metagenome
...
--> no proof of what is selected for
--> more data on how consistent partnership is.
...
Who controls who, or is that not a sense-making perspective. Is iet perhaps a perspective of how entities "talk to" and "trade with" each other.
...
In a fourth publication, we analysed putative genes coding for phytohormones: Salicylic and jasmonic
...
JC Villarreal /, O Meléndez, R Bethancourt… - Microbiology Resource …, 2024
