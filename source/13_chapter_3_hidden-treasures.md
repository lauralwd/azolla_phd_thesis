...
In constrast, a second cyanobacterium found in the _A. filiculoides_ 'wild' assembly, is present only on the outside of the ferns, and not in the leaf cavity enriched fraction nor in the lab dericed assemblies.
This indicates that this particular cyanobacterium is epithitic; consistent with earlier findings that _Azolla_ has only one cyanobacterial symbiont.
...
In none case of manual metagenome binning, CAT taxonomy was used as input for the clustering dendograms in any of the Anvi'o figures.
